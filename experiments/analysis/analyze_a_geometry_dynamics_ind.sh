...
#SBATCH --output=/scratch2/jliu/Generative_replay/neuron/logs/analysis/geometry_ind_%a.log
#SBATCH --array=0-17%6  # Modified array size to include all combinations
...
TOTAL_COMBINATIONS=$((TOTAL_MODELS * TOTAL_VECTORS * TOTAL_TOP_NS * TOTAL_HEURISTICS * TOTAL_GROUP_SIZES * TOTAL_STEP_INDEXS))
