...
python $SCRIPT_ROOT/analyze_unigram.py -m EleutherAI/pythia-70m-deduped --top_n 10
python $SCRIPT_ROOT/analyze_unigram.py -m EleutherAI/pythia-70m-deduped --top_n 50
