...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Test token h changes in differnet conditions")
    parser.add_argument(
        "-w",
        "--word_path",
        type=Path,
...
-> in the case of the rare vec, do the common token surprisals change before and after ablation? 

-> we can directly find some in current implementation
