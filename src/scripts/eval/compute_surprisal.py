...
from neuron_analyzer.eval.surprisal import StepConfig, StepSurprisalExtractor, load_eval, load_neuron_dict, sel_eval
...
def main() -> None:
    ...
    steps_config = StepConfig(resume=args.resume, debug=args.debug, file_path=resume_file, interval=args.interval)
